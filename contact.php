...
<ul class="list-group">
  <li class="list-group-item " id= "headerr">ორგანიზაციის წევრები</li>
  <li class="list-group-item">დამფუძნებელი: ლევან გათიაშვილი</li>
  <li class="list-group-item">დირექტორი: ლუკა გელაშვილი</li>
  <li class="list-group-item">მენეჯერი: მარიამ პაპიაშვილი
</li>
  <li class="list-group-item">ბუღალტერი: მედეა პავლიაშვილი
</li>
<li class="list-group-item">წევრები: ანა აკოფოვი, ქეთი ჯაფარიძე, ლევან ოგანეზიანი, თამთა ლომიძე</li>

<li class="list-group-item">ოპერატორი: ილია მათიაშვილი</li>
<li class="list-group-item">მუსიკალური გაფორმება: გიორგი ფილიშვილი, 
გიორგი თოდაძე</li>
...
<br>
<ul class="list-group">
<li class="list-group-item " id= "headerr" onclick="location.href = 'https://www.facebook.com/profile.php?id=100008977568455&fref=nf'" style="cursor: pointer;"><i class="fa fa-facebook-square" aria-hidden="true"></i>  ჩვენი Facebook გვერდი</li>
</ul>
</div>
<br>
<center><div id="googleMap1" style="width:83%;height:500px"></div></center>
<script type="text/javascript">
function myMap() {
  var mapCanvas = document.getElementById("googleMap1");
  var MyCenter  = new google.maps.LatLng(41.691887, 44.820509);
...
<script  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyChlBY6SAzYMjQFio6I2Voy6bYTC4Mj4sE&callback=myMap"></script>
